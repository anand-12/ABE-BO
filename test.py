...
if __name__ == "__main__":
    ...
    os.makedirs(f"./Results_abe", exist_ok=True)
    ...
    np.save(f"./Results_abe/{args.function}_{filename}", all_results_np)

    print(f"Results saved to ./Results/{args.function}_{filename}")